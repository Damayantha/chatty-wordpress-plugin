...
Then activate **PersonaliAI Customer Support Chatbot** from the WordPress admin's Plugins page
...
personaliai-customer-support-chatbot/
  personaliai-customer-support-chatbot.php   Main plugin file — settings page, sanitization,
...
vendor/bin/phpcs --standard=WordPress-Extra personaliai-customer-support-chatbot/
```
